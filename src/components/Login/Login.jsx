...
const Login = ({ onLoginSuccess }) => {
	...
	return (
		<div className="flex h-screen items-center justify-center bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${LoginBanner})` }}>
			{/* Left section with small logo */}
			<div className="hidden sm:flex flex-col items-start justify-center space-y-2 p-12">
